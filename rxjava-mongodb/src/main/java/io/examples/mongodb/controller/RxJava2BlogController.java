...
public class RxJava2BlogController {
    ...
    @GetMapping(value = "/{id}")
    public Single<ResponseEntity<?>> byId(@PathVariable("id") String id) {
    ...
    public Single<ResponseEntity> delete(@PathVariable("id") String id) {
    ...
    public Single<ResponseEntity<?>> update(@PathVariable("id") String id, @RequestBody Blog blog) {
